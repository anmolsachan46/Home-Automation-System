...
public class menu extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
	    ...
	    final ToggleButton button2 = (ToggleButton) findViewById(R.id.ToggleButton01);
	    ...
	    final ToggleButton button3 = (ToggleButton) findViewById(R.id.ToggleButton02);
	    ...
	    final ToggleButton button4 = (ToggleButton) findViewById(R.id.ToggleButton03);
